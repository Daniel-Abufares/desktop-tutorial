...
# --- נתוני סנכרון ממקור אוטומטי (אופציונלי) -------------------------------
# הקבצים האלה אינם תלויי-ספק: כל מקור שיודע לכתוב אותם בסכימה שלמטה מקבל
# רצועת חיבורים וכרטיס יתרות בדשבורד. כשהם לא קיימים — הרכיבים לא מרונדרים
# כלל, ומסלולי ה-CSV/Drive עובדים כרגיל.
